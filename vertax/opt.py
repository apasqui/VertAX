...
def minimize(vertTable, heTable, faceTable, 
             vert_params, he_params, face_params,
             L_in, solver, min_dist_T1,
             iterations_max=1e3, tolerance=1e-4, patience=5,
             selected_verts=None, selected_hes=None, selected_faces=None, argnums=0): 
    ...
    def update_step(carry):
        ...
        # 1) Compute loss
        L_current = L_in(
            vt[selected_verts], ht[selected_hes], ft[selected_faces],
            vp[selected_verts], hp[selected_hes], fp[selected_faces]
        )
    ...
    final_state = lax.while_loop(
        cond_fn, update_step,
        (vertTable, heTable, faceTable, vert_params, he_params, face_params,
         opt_state, prev_L_values, stagnation_count, step_count, should_stop, L_in_list)
    )
...
def inner_opt(vertTable, heTable, faceTable,
              vert_params, he_params, face_params,
              L_in, solver, min_dist_T1,
              iterations_max=1e3, tolerance=1e-4, patience=5,
...
def cost_ad(vertTable, heTable, faceTable,
            vert_params, he_params, face_params,
            vertTable_target, heTable_target, faceTable_target,
            L_in, L_out, solver_inner, min_dist_T1,
            iterations_max=1e3, tolerance=1e-4, patience=5,
            selected_verts=None, selected_hes=None, selected_faces=None, image_target=None):
    
    (vertTable, heTable, faceTable), L_in = inner_opt(vertTable, heTable, faceTable,
                                                      vert_params, he_params, face_params,
                                                      L_in, solver_inner, min_dist_T1,
                                                      iterations_max, tolerance, patience,
                                                      selected_verts, selected_hes, selected_faces)
            
    loss_out_value = L_out(vertTable, heTable, faceTable, 
                           vertTable_target, heTable_target, faceTable_target,
                           selected_verts, selected_hes, selected_faces, image_target)
    
    return loss_out_value

def outer_opt(vertTable, heTable, faceTable, 
              vert_params, he_params, face_params,
              vertTable_target, heTable_target, faceTable_target, 
              L_in, L_out, solver_inner, solver_outer, 
              min_dist_T1, iterations_max, tolerance, patience, 
              selected_verts, selected_hes, selected_faces, image_target):

    grad_verts = jacfwd(cost_ad, argnums=3)(vertTable, heTable, faceTable,
                                            vert_params, he_params, face_params,
                                            vertTable_target, heTable_target, faceTable_target,
                                            L_in, L_out, solver_inner, min_dist_T1,
                                            iterations_max, tolerance, patience,
    ...
    grad_hes = jacfwd(cost_ad, argnums=4)(vertTable, heTable, faceTable,
                                          vert_params, he_params, face_params,
                                          vertTable_target, heTable_target, faceTable_target,
                                          L_in, L_out, solver_inner, min_dist_T1,
                                          iterations_max, tolerance, patience,
    ...
    grad_faces = jacfwd(cost_ad, argnums=5)(vertTable, heTable, faceTable,
                                            vert_params, he_params, face_params,
                                            vertTable_target, heTable_target, faceTable_target,
                                            L_in, L_out, solver_inner, min_dist_T1,
                                            iterations_max, tolerance, patience,
...
def loss_ep(vertTable, heTable, faceTable, 
            vert_params, he_params, face_params, 
            vertTable_target, heTable_target, faceTable_target,
            L_in, L_out,
            selected_verts, selected_hes, selected_faces, 
    ...
    loss_outer_value = L_out(vertTable, heTable, faceTable, 
                             vertTable_target, heTable_target, faceTable_target, 
                             selected_verts, selected_hes, selected_faces, image_target)
...
def forward(vertTable, heTable, faceTable,
            vert_params, he_params, face_params, 
            vertTable_target, heTable_target, faceTable_target,
            L_in, L_out, solver_inner, 
            min_dist_T1, iterations_max, tolerance, patience,
            selected_verts, selected_hes, selected_faces,
            image_target, beta):
...
def outer_eq_prop(vertTable, heTable, faceTable, 
                  vert_params, he_params, face_params, 
                  vertTable_target, heTable_target, faceTable_target, 
                  L_in, L_out, solver_inner, solver_outer, 
                  min_dist_T1, iterations_max, tolerance, patience, 
    ...
    (vertTable_free, heTable_free, faceTable_free), loss_free = forward(vertTable, heTable, faceTable,
                                                                        vert_params, he_params, face_params, 
                                                                        vertTable_target, heTable_target, faceTable_target,
                                                                        L_in, L_out, solver_inner, 
                                                                        min_dist_T1, iterations_max, tolerance, patience,
    ...
    (vertTable_nudged, heTable_nudged, faceTable_nudged), loss_nudged = forward(vertTable, heTable, faceTable,
                                                                                vert_params, he_params, face_params, 
                                                                                vertTable_target, heTable_target, faceTable_target,
                                                                                L_in, L_out, solver_inner, 
                                                                                min_dist_T1, iterations_max, tolerance, patience,
    ...
    grad_loss_ep_free_verts = jacfwd(loss_ep, argnums=3)(vertTable_free, heTable_free, faceTable_free, 
                                                         vert_params, he_params, face_params, 
                                                         vertTable_target, heTable_target, faceTable_target,
                                                         L_in, L_out,
                                                         selected_verts, selected_hes, selected_faces, 
    ...
    grad_loss_ep_nudged_verts = jacfwd(loss_ep, argnums=3)(vertTable_nudged, heTable_nudged, faceTable_nudged, 
                                                           vert_params, he_params, face_params, 
                                                           vertTable_target, heTable_target, faceTable_target,
                                                           L_in, L_out,
                                                           selected_verts, selected_hes, selected_faces, 
    ...
    grad_loss_ep_free_hes = jacfwd(loss_ep, argnums=4)(vertTable_free, heTable_free, faceTable_free, 
                                                       vert_params, he_params, face_params, 
                                                       vertTable_target, heTable_target, faceTable_target,
                                                       L_in, L_out,
                                                       selected_verts, selected_hes, selected_faces, 
    ...
    grad_loss_ep_nudged_hes = jacfwd(loss_ep, argnums=4)(vertTable_nudged, heTable_nudged, faceTable_nudged, 
                                                         vert_params, he_params, face_params, 
                                                         vertTable_target, heTable_target, faceTable_target,
                                                         L_in, L_out,
                                                         selected_verts, selected_hes, selected_faces, 
    ...
    grad_loss_ep_free_faces = jacfwd(loss_ep, argnums=5)(vertTable_free, heTable_free, faceTable_free, 
                                                         vert_params, he_params, face_params, 
                                                         vertTable_target, heTable_target, faceTable_target,
                                                         L_in, L_out,
                                                         selected_verts, selected_hes, selected_faces, 
    ...
    grad_loss_ep_nudged_faces = jacfwd(loss_ep, argnums=5)(vertTable_nudged, heTable_nudged, faceTable_nudged, 
                                                           vert_params, he_params, face_params, 
                                                           vertTable_target, heTable_target, faceTable_target,
                                                           L_in, L_out,
                                                           selected_verts, selected_hes, selected_faces, 
...
def outer_implicit(vertTable, heTable, faceTable, 
                   vert_params, he_params, face_params, 
                   vertTable_target, heTable_target, faceTable_target, 
                   L_in, L_out, solver_inner, solver_outer, 
                   min_dist_T1, iterations_max, tolerance, patience,
    ...
    (vertTable_eq, heTable_eq, faceTable_eq), L_in_value = inner_opt(vertTable, heTable, faceTable,
                                                                     vert_params, he_params, face_params,
                                                                     L_in, solver_inner, min_dist_T1,
                                                                     iterations_max, tolerance, patience,
                                                                     selected_verts, selected_hes, selected_faces)
    
    H=jacfwd(jacfwd(L_in_flatten,argnums=0),argnums=0)(vertTable_eq[:,:2].flatten(), heTable_eq, faceTable_eq, vert_params, he_params, face_params)

    crossderivative_verts=jacfwd(jacfwd(L_in_flatten,argnums=0),argnums=3)(vertTable_eq[:,:2].flatten(), heTable_eq, faceTable_eq, vert_params, he_params, face_params)
    crossderivative_hes=jacfwd(jacfwd(L_in_flatten,argnums=0),argnums=4)(vertTable_eq[:,:2].flatten(), heTable_eq, faceTable_eq, vert_params, he_params, face_params)
    crossderivative_faces=jacfwd(jacfwd(L_in_flatten,argnums=0),argnums=5)(vertTable_eq[:,:2].flatten(), heTable_eq, faceTable_eq, vert_params, he_params, face_params)
    ...
    grad_verts = L_in_derivative_verts.T @ grad(L_out,argnums=0)(vertTable_eq, heTable_eq, faceTable_eq, vertTable_target, heTable_target, faceTable_target, image_target)[:,:2].flatten()
    grad_hes = L_in_derivative_hes.T @ grad(L_out,argnums=0)(vertTable_eq, heTable_eq, faceTable_eq, vertTable_target, heTable_target, faceTable_target, image_target)[:,:2].flatten()
    grad_faces = L_in_derivative_faces.T @ grad(L_out,argnums=0)(vertTable_eq, heTable_eq, faceTable_eq, vertTable_target, heTable_target, faceTable_target, image_target)[:,:2].flatten()
...
def outer_adjoint_state(vertTable, heTable, faceTable, 
                        vert_params, he_params, face_params,
                        vertTable_target, heTable_target, faceTable_target, 
                        L_in, L_out, solver_inner, solver_outer, 
                        min_dist_T1, iterations_max, tolerance, patience,
    ...
    crossderivative_verts=jacfwd(jacfwd(L_in_flatten,argnums=3),argnums=0)(vertTable_eq[:,:2].flatten(), heTable_eq, faceTable_eq, vert_params, he_params, face_params)
    crossderivative_hes=jacfwd(jacfwd(L_in_flatten,argnums=4),argnums=0)(vertTable_eq[:,:2].flatten(), heTable_eq, faceTable_eq, vert_params, he_params, face_params)
    crossderivative_faces=jacfwd(jacfwd(L_in_flatten,argnums=5),argnums=0)(vertTable_eq[:,:2].flatten(), heTable_eq, faceTable_eq, vert_params, he_params, face_params)

    gradout=grad(L_out,argnums=0)(vertTable_eq, heTable_eq, faceTable_eq, vertTable_target, heTable_target, faceTable_target, image_target)[:,:2].flatten()
...
def bilevel_opt(vertTable, heTable, faceTable, 
                vert_params, he_params, face_params, 
                vertTable_target, heTable_target, faceTable_target, 
                L_in, L_out, solver_inner, solver_outer, 
                min_dist_T1, iterations_max, tolerance, patience, 
                selected_verts, selected_hes, selected_faces, 
                image_target=None, beta=None, method='ad'):

    if method == 'ad':

        vert_params, he_params, face_params = outer_opt(vertTable, heTable, faceTable, 
                                                        vert_params, he_params, face_params, 
                                                        vertTable_target, heTable_target, faceTable_target, 
                                                        L_in, L_out, solver_inner, solver_outer, 
                                                        min_dist_T1, iterations_max, tolerance, patience, 
        ...
        (vertTable, heTable, faceTable), cost = inner_opt(vertTable, heTable, faceTable,  
                                                          vert_params, he_params, face_params, 
                                                          L_in, solver_inner, 
                                                          min_dist_T1, iterations_max, tolerance, patience,
                                                          selected_verts, selected_hes, selected_faces)
        ...
        vert_params, he_params, face_params = outer_eq_prop(vertTable, heTable, faceTable, 
                                                            vert_params, he_params, face_params,
                                                            vertTable_target, heTable_target, faceTable_target, 
                                                            L_in, L_out, solver_inner, solver_outer, 
                                                            min_dist_T1, iterations_max, tolerance, patience,
        ...
        (vertTable, heTable, faceTable), cost = forward(vertTable, heTable, faceTable, 
                                                        vert_params, he_params, face_params, 
                                                        vertTable_target, heTable_target, faceTable_target,
                                                        L_in, L_out, solver_inner, 
                                                        min_dist_T1, iterations_max, tolerance, patience, 
                                                        selected_verts, selected_hes, selected_faces, image_target, beta=0.)

    elif method == 'id': 

        vert_params, he_params, face_params = outer_implicit(vertTable, heTable, faceTable, 
                                                             vert_params, he_params, face_params, 
                                                             vertTable_target, heTable_target, faceTable_target, 
                                                             L_in, L_out, solver_inner, solver_outer, 
                                                             min_dist_T1, iterations_max, tolerance, patience,
        ...
        vert_params, he_params, face_params = outer_adjoint_state(vertTable, heTable, faceTable, 
                                                                  vert_params, he_params, face_params,
                                                                  vertTable_target, heTable_target, faceTable_target, 
                                                                  L_in, L_out, solver_inner, solver_outer, 
                                                                  min_dist_T1, iterations_max, tolerance, patience,
