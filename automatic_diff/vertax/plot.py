...
def plot_geograph(vertTable, faceTable, heTable, L_box, flip_x=False, flip_y=False, multicolor=True, lines=True, vertices=True, path='.', name='-1', save=False, show=True):
