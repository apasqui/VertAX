...
from vertax.opt import forward, outer_eq_prop
...
vertTable_free, heTable_free, faceTable_free = forward(vertTable_init, 
                                                       heTable_init, 
                                                       faceTable_init, 
                                                       vertTable_target,
                                                       areas_params, 
...
plot_geograph(vertTable_free.astype(float), 
              heTable_free.astype(int), 
              faceTable_free.astype(int), 
              L_box=L_box, 
              multicolor=True, 
              lines=True, 
              vertices=False, 
...
for _ in tqdm(range(epochs)):
    ...
    # print(cost_v2v(vertTable_free, heTable_free, faceTable_free, vertTable_target))

    loss_inner.append(energy(vertTable_free, heTable_free, faceTable_free, areas_params, edges_params))
    loss_outer.append(cost_v2v(vertTable_free, heTable_free, faceTable_free, vertTable_target))

    areas_params, edges_params = outer_eq_prop(vertTable_free=vertTable_free, 
                                               heTable_free=heTable_free, 
                                               faceTable_free=faceTable_free,
                                               vertTable_nudged=vertTable_free.copy(), 
                                               heTable_nudged=heTable_free.copy(), 
                                               faceTable_nudged=faceTable_free.copy(),
                                               vertTable_target=vertTable_target,
