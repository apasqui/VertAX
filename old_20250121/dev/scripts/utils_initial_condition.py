...
def periodicVoronoi(L_box: float, n_cells: int, seeds: np.array, show: bool):
    ...
    os.makedirs('../../src/vertAX/initial_conditions_voronoi/', exist_ok=True)

    np.savetxt('../../src/vertAX/initial_conditions_voronoi/vertTable.csv', vertTable, delimiter='\t', fmt='%1.18f')
    np.savetxt('../../src/vertAX/initial_conditions_voronoi/faceTable.csv', faceTable, delimiter='\t', fmt='%1.0d')
    np.savetxt('../../src/vertAX/initial_conditions_voronoi/heTable.csv', heTable, delimiter='\t', fmt='%1.0d')

    vertTable = np.loadtxt('../../src/vertAX/initial_conditions_voronoi/vertTable.csv', delimiter='\t', dtype=np.float64)
    faceTable = np.loadtxt('../../src/vertAX/initial_conditions_voronoi/faceTable.csv', delimiter='\t', dtype=np.int32)
    heTable = np.loadtxt('../../src/vertAX/initial_conditions_voronoi/heTable.csv', delimiter='\t', dtype=np.int32)

    np.save('../../src/vertAX/initial_conditions_voronoi/simulation_vertTable', vertTable)
    np.save('../../src/vertAX/initial_conditions_voronoi/simulation_faceTable', faceTable)
    np.save('../../src/vertAX/initial_conditions_voronoi/simulation_heTable', heTable)

    os.remove('../../src/vertAX/initial_conditions_voronoi/vertTable.csv')
    os.remove('../../src/vertAX/initial_conditions_voronoi/faceTable.csv')
    os.remove('../../src/vertAX/initial_conditions_voronoi/heTable.csv')

    plot_periodic_voronoi(vertTable.astype(float),
                          faceTable.astype(int),
                          heTable.astype(int),
                          L_box=L_box, multicolor=True, lines=True,
                          vertices=False, show=show)
